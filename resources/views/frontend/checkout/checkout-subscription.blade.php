    ...
    <div class="container py-5">
        <div class="row">
            <div class="col-lg-8 mx-auto">
                ...
                @auth
                    @php
                        $amount = \App\SubscriptionPlanPrice::where('plan_id',$plan->id)->where('country_id', \Illuminate\Support\Facades\Auth::user()->country)->first();
                    @endphp
                    @if ($amount->price > 0)
                        <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="tab-content">
                                        <div id="credit-card" class="tab-pane fade show active pt-3">
                                            <form role="form" action="{{ route('capture.subscription.payment') }}" method="post"
                                        ...
                                        <div id="paypal" class="tab-pane fade pt-3">
                                            <a href="{{ route('make.subs.paypal.payment',[encrypt($plan->id)]) }}" class="btn btn-primary ">
                    ...
                    @else
                        <div class="card">
                            <div class="card-body">
                                <a href="{{ route('subscription.confirm',encrypt($plan->id)) }}" class="btn btn-primary ">
                ...
                @else
                    <div class="login-register-page">
                            ...
                            <!-- Form -->
                            <form method="post" action="{{route('check-login-subscription')}}">
                                @csrf
