                    ...
                    <div class="card-body">
                        ...
                        <div class="tab-content">
                            <div id="credit-card" class="tab-pane fade show active pt-3">
                                <form role="form" action="{{ route('capture.job.payment') }}" method="post"
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <input type="hidden" name="candidateId" value="{{ $serviceProviderId }}">
                            ...
                            <div id="paypal" class="tab-pane fade pt-3">
                                <a href="{{ route('make.paypal.payment',[encrypt($jobId),encrypt($serviceProviderId)]) }}" class="btn btn-primary ">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="payable-list">
                            {{ __('Sub Total') }} <span
                                class="float-right">{{ env('CURRENCY_SYMBOL') }}{{ $amount->bid_amount }}</span>
                        </div>
                        <div class="payable-list">
                            {{ __('Charge') }} <span
                                class="float-right">{{ env('CURRENCY_SYMBOL') }}{{ $extra }}</span>
                        </div>
                        <div class="payable-list">
                            <strong>{{ __('Grand Total') }}</strong> <span
                                class="float-right">{{ env('CURRENCY_SYMBOL') }}{{ $extra+$amount->bid_amount }}</span>
                        </div>
                    </div>
                </div>
            </div>
