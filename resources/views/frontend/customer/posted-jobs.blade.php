                ...
                <div class="row">
                    ...
                    <div class="col-xl-12">
                        <div class="dashboard-box margin-top-0">
                            ...
                            <!-- Headline -->
                            <div class="headline">
                                <h3><i class="icon-material-outline-business-center"></i> {{ __('Posted Job List') }}
                                </h3>
                            </div>
                                        ...
                                        @foreach($jobs as $applied)
                                            <li>
                                                ...
                                                <div class="buttons-to-right always-visible">
                                                    <a href="{{ route('job.applications',encrypt($applied->id)) }}"
                                                       class="button ripple-effect"><i
                                                            class="icon-feather-eye"></i> {{ __('View Applications') }}</a>
                                                </div>
                                            </li>
                                        @endforeach
                                    @endif
