...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{ __('Edit Contractor') }}</li>
            </ol>
            <!-- Breadcrumb end -->

            <!-- App actions start -->
            <div class="app-actions">
                <a href="{{ route('admin.contractors') }}" class="btn active">{{ __('All Contractors') }}</a>
            </div>
            <!-- App actions end -->
        ...
        <div class="row gutters">
            <form class="col-md-12" action="{{ route('admin.update.contractor') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="card-title">{{ __('Contractor Information') }}</div>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('First Name') }}" name="first_name" required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Last Name') }}" name="last_name" required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Mobile Number') }}" name="mobile_number" required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Address Line 1') }}" name="address_line_1" required
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Address Line 2') }}" name="address_line_2"
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <select name="country" class="form-control @error('country') is-invalid @enderror select2" required onchange="getStates();" id="country">
                            ...
                            <div class="col-md-6 state">
                                ...
                                <div class="col-sm-12">
                                    <select id="state" name="state" class="form-control @error('state') is-invalid @enderror select2" required>
                                        <option value="">{{ __('Select State') }}</option>
                                        @foreach($states as $state)
                                            <option value="{{ $state->id }}" @if($state->id == $customer->state) selected @endif>{{ $state->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('state')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                ...
                                <div class="col-sm-12">
                                    <select id="city" name="city" class="form-control @error('city') is-invalid @enderror select2" required>
                                        ...
                                        @foreach($cities as $city)
                                            <option value="{{ $city->id }}" @if($city->id == $customer->city) selected @endif>{{ $city->name }}</option>
                                        @endforeach
                                    </select>
                                    @error('city')
                                    <div class="invalid-feedback">{{ $message }}</div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="col-sm-12">
                                    <select name="status" id="status" class="form-control">
                                        ...
                                        <option value="0" @if($customer->status == 0) selected @endif>{{ __('Inactive') }}</option>
                                    </select>
                                    @error('status')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
