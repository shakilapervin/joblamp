...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            ...
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{ __('All Skills') }}</li>
            </ol>
            <!-- Breadcrumb end -->
            <div class="app-actions">
                <a href="{{ route('admin.create.skill') }}" class="btn active">{{ __('Add New Skill') }}</a>
            </div>
        </div>
        <!-- Page header end -->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.edit.skill', $skill->id)}}">{{__('Edit')}}</a>
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.delete.skill', $skill->id)}}" onclick="return confirm('Are you sure?')">{{__('Delete')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
