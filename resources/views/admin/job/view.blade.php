                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group row">
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           class="form-control form-control @error('start_date') is-invalid @enderror"
                                           id="colFormLabelSm" placeholder="{{ __('Start Date') }}" name="start_date"
                                           required
                                           value="{{ $job->start_date }}" readonly disabled>
                                    @error('start_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           class="form-control form-control @error('end_date') is-invalid @enderror"
                                           id="colFormLabelSm" placeholder="{{ __('Start Date') }}" name="end_date"
                                           required
                                           value="{{ $job->end_date }}" disabled readonly>
                                    @error('end_date')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6 state">
                                ...
                                <div class="col-sm-12">
                                    <select id="state" name="state"
                                            class="form-control @error('state') is-invalid @enderror select2" required readonly="" disabled>
                            ...
                            <div class="col-md-6 city">
                                ...
                                <div class="col-sm-12">
                                    <select id="city" name="city"
                                            class="form-control @error('city') is-invalid @enderror select2" required readonly="" disabled>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Free Range Min') }}" name="fee_range_min"
                                           required
                                           value="{{ $job->fee_range_min }}" disabled>
                                    @error('fee_range_min')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="col-sm-12">
                                    <input type="text"
                                           ...
                                           id="colFormLabelSm" placeholder="{{ __('Free Range Max') }}" name="fee_range_max"
                                           required
                                           value="{{ $job->fee_range_max }}" disabled>
                                    @error('fee_range_max')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
