...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{ __('Add New Prize') }}</li>
            </ol>
            <!-- Breadcrumb end -->
        ...
        <div class="row gutters">
            <form class="col-md-12" action="{{ route('admin.store.prize') }}" method="post"
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_en" id="" cols="30" rows="10" class="form-control @error('details_en') is-invalid @enderror"></textarea>
                                @error('details_en')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_es" id="" cols="30" rows="10" class="form-control @error('details_es') is-invalid @enderror"></textarea>
                                @error('details_es')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_fr" id="" cols="30" rows="10" class="form-control @error('details_fr') is-invalid @enderror"></textarea>
                                @error('details_fr')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_de" id="" cols="30" rows="10" class="form-control @error('details_de') is-invalid @enderror"></textarea>
                                @error('details_de')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_ro" id="" cols="30" rows="10" class="form-control @error('details_ro') is-invalid @enderror"></textarea>
                                @error('details_ro')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-12">
                                <textarea name="details_pt" id="" cols="30" rows="10" class="form-control @error('details_pt') is-invalid @enderror"></textarea>
                                @error('details_pt')
                                <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
