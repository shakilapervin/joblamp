...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            ...
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{ __('City List') }}</li>
            </ol>
            <!-- Breadcrumb end -->

            <div class="app-actions">
                <a href="{{ route('admin.add.city') }}" class="btn active">{{ __('Add New City') }}</a>
            </div>
        </div>
        <!-- Page header end -->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.edit.city', $city->id)}}">{{__('Edit')}}</a>
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.delete.city', $city->id)}}" onclick="return confirm('Are you sure?')">{{__('Delete')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
