...
@section('content')
    ...
    <div class="main-container">
        ...
        <div class="page-header">
            ...
            <!-- Breadcrumb start -->
            <ol class="breadcrumb">
                <li class="breadcrumb-item">{{ __('Job Sub Categories') }}</li>
            </ol>
            <!-- Breadcrumb end -->
            <div class="app-actions">
                <a href="{{ route('admin.add.job.subcategory') }}" class="btn active">{{ __('Add New Sub Category') }}</a>
            </div>
        </div>
        <!-- Page header end -->
                                            ...
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.edit.job.subcategory', $category->id)}}">{{__('Edit')}}</a>
                                                    <a class="dropdown-item"
                                                       href="{{route('admin.delete.job.subcategory', $category->id)}}" onclick="return confirm('Are you sure?')">{{__('Delete')}}</a>
                                                </div>
                                            </div>
                                        </td>
                                    </tr>
