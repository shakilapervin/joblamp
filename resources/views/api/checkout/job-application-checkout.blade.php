                ...
                <div class="card-body">
                    ...
                    <div class="tab-content">
                        <div id="credit-card" class="tab-pane fade show active pt-3">
                            <form role="form" action="{{ route('api.capture.stripe.job.application.payment') }}" method="post"
                        ...
                        <div id="paypal" class="tab-pane fade pt-3">
                            <a href="{{ route('api.make.job.application.paypal.payment',[$user_id,$job_id]) }}" class="btn btn-primary">
